## THIS SCRIPT SIMULATE DATA WITH GAUSSIAN INNOVATIONS FROM MASSACCI ET AL. (2026)
...
for(n in seq_along(vN)){
  ...
  lFoo = get_data_latentFactor.bis(lInput)
  lData[[n]] = lFoo
}
...
save(lData, file = "C:/Users/pierl/Dropbox/Massacci_Sarno_Trapani2/Simulations/sim_data/Size/SizeLatentFactor_PhiNu040.Rdata")
