...
Results using the output of the above functions may differ across different R versions. Experiments with the output of the above scripts showed qualitatively similar results with respect to those of the paper. Our data were generated with the December 2024 version of R and are available at this [link](https://www.dropbox.com/scl/fo/t2xs8jsmeu2zqn0gkf8ch/ANzZT-yhEcC504yvOodJygs?rlkey=ujdz0p8jvaypyq3rq772inb9u&st=c3at1xbd&dl=0) for perfect replication.
