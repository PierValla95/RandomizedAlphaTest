...
Before running the scripts, data must be generated and saved using the scripts "SimulateGaussianData.R", "SimulateTData.R", and "SimulateGARCHData.R". For all these script, setting Type="size" simulates data under the null, while data under the alternative are simulated by setting Type="power".
